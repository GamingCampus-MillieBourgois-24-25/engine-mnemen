...
target("Wren")
    set_kind("static")
    set_languages("c17")
    add_files("wren/src/vm/*.c", "wren/src/optional/*.c")
    add_headerfiles("wren/**.h")
    add_includedirs("wren/src/include", "wren/src/optional", "wren/src/vm")

target("Wren++")
    set_kind("static")
    set_languages("c++14")
    add_files("Wren++/Wren++.cpp")
    add_headerfiles("Wren++/Wren++.h")
    add_includedirs("wren/src/include", "wren/src/optional", "wren/src/vm")
    add_deps("Wren")
